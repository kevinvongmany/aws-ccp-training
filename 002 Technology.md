# Technology
Largest part of the exam. Will make up at least 33% of the questions.
...
### Lightsail
Deploy all resources needed for small projects, like WordPress sites. Good for people with no cloud experience
$3.50 monthly fee as a starter.

### Outposts
Connects on-prem servers to allow cloud services. Basically supports hybrid deployeents.
...
In terms of durability, S3 Standard class offers eleven 9s of durability (99.999999999%), meaning your chance of losing the file due to corruption in S3 is tiny.
...
### EC2 Storage Elastic Block Store (EBS)
...
### EC2 Storage Elastic File System (EFS)
...
1. Snowcone (up to 8TB of data), smallest and cheapest family member.
...
### DataSync
Allows online data transfer from on-prem to AWS through S3 or EFS. Different from snow family that it requires the source data transfer to also be online or via VPN/Direct Connect.
...
### Redshift
A data warehouse service that allows scalable storage of large data, useful for big data. Handles up to exabytes of data. This is the service that most of the following analytics services can easily work with.
...
### Kinesis
Realtime analytics for videos and streaming data.
...
### Elastic Beanstalk
A compute service used to deploy web apps or services to AWS. Handles all of the deployment so you don't have to think about provisioning hardware or resources. Also provides a health dashboard of any apps you deploy through Elastic Beanstalk.
...
Messaging queue service that supports loosely coupled microservices to process data or tasks FIFO. Messages within the SQS queue are processed asynchronously.
